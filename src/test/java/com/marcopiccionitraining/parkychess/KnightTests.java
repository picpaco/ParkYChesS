...
public class KnightTests {
    ...
    void whiteKnightOnTheCenterThreePossibleCaptureJumps() {
        ChessGame gameState = new ChessGame(chessboard, FEN_BLACK_KNIGHT_D5_NO_CHECK_8_MIXED_JUMPS_POSITION);
    ...
    void whiteKnightOnTheCornerTwoPossibleJumps() {
        ChessGame gameState = new ChessGame(chessboard, FEN_WHITE_KNIGHT_CORNER_2_JUMPS_POSITION);
    ...
    void whiteKnightOnTheRimOnePossibleJump() {
        ChessGame gameState = new ChessGame(chessboard, FEN_WHITE_KNIGHT_RIM_1_JUMP_POSITION);
    ...
    void whiteKnightOnTheCenterNoLegalJumps() {
        ChessGame gameState = new ChessGame(chessboard, FEN_WHITE_KNIGHT_E5_NO_CHECK_NO_LEGAL_JUMPS_POSITION);
