...
public class Board {
    ...
    private static final HashMap<Position, ArrayList<Position>> bishopInsideBoardPositions = new HashMap<>();
    ...
    private static void initializeBishopPositionsInsideBoard() {
        ...
        for (int i = 1; i < 8; i++) {
            destinations.add(new Position(i, i));
        }
        bishopInsideBoardPositions.put(new Position(0,0), destinations);
        destinations = new ArrayList<>();
        destinations.add(new Position(1, 0));
        for (int i = 1; i < 7; i++) {
            destinations.add(new Position(i, i+1));
        }
        bishopInsideBoardPositions.put(new Position(0,1), destinations);
    }
